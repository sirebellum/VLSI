...
HD_PWD='C:/Users/temp/gits/VLSI/assignment1/assignment1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Dflip.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Dflip.tcl
